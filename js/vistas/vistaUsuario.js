...
VistaUsuario.prototype = {
  ...
  reconstruirLista: function() {
    ...
    preguntas.forEach(function(clave){
      ...
      var nuevaPregunta = $('<div>',{value: clave.textoPregunta, text: clave.textoPregunta,id: clave.id});
  ...
  votar: function(votosPorPregunta){
    var contexto = this;
    votosPorPregunta.forEach(function(elemento){
      contexto.controlador.agregarVoto(elemento.preg,elemento.resp);
    });
  },

  agregarVotos: function(){
    var contexto = this;
    var votosPorPregunta =[]
    $('#preguntas').find('div').each(function(){
        ...
        if(respuestaSeleccionada == undefined){
          //Si no esta seleccionada ninguna opcion, no la tengo en cuenta
        }else{
          votosPorPregunta.push({preg: pregunta,resp: respuestaSeleccionada});
        }
      });
      console.log(votosPorPregunta);
      this.votar(votosPorPregunta);
      this.desactivarCheckeados();
  },
